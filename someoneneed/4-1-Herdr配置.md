---
title: Herdr 配置完成：6 步上手多窗格终端
slug: herdr-config
summary: Herdr 0.8.0 配置完成：心智模型、6 步上手、快捷键表与基于外部反馈的 Review 方法论。
description: 记录 Herdr 0.8.0（stable 通道）的安装状态与 OMP 集成配置，涵盖会话、工作区、标签页、窗格、智能体的心智模型，鼠标与键盘操作，分离客户端与破坏性操作的边界，以及源自 LLM 自我纠正研究的四种 Review 提示与个人操作 SOP。
---
...
* <https://github.com/herdrdev/herdr>
  ...
  * 退出 ctrl+b q
  * herdr server stop
  * 多 agent 互相沟通 use the herdr cli / use herdr cli to talk to codex
